package com.arthur.libraryapi.config;

import com.arthur.libraryapi.security.CustomAuthentication;
...
public class AuthorizationServerConfiguration {
    ...
    public TokenSettings tokenSettings(){
        return TokenSettings.builder()
                ...
                //acess_token = token utilizado na requisições
                .accessTokenTimeToLive(Duration.ofMinutes(60))
                //refresh_token= token para renovar os acess_token
    ...
    //JWK - JSON Web Key
    @Bean
    public JWKSource<SecurityContext> jwksSource() throws Exception {
